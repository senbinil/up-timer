...
export default class extends Controller {
  ...
  toggle() {
    ...
    const menuWrap = this.element.querySelector('[data-mobile-nav-target="menuIconWrap"]')
    const closeWrap = this.element.querySelector('[data-mobile-nav-target="closeIconWrap"]')
